...
const PodcastPlayer = {
    ...
    init() {
        ...
        console.log('Podcast Player inicializado');
    },
    ...
    load(lessonId) {
        ...
        // Verificar si el archivo existe (asumimos que sí por ahora)
        ...
        console.log('Podcast cargado:', podcastPath);
    },
    ...
    togglePlay() {
        if (!this.audio.src) {
            console.warn('No hay podcast cargado');
            return;
        }
     ...
     */
    onError(e) {
        console.warn('Error cargando podcast:', e);
        this.durationEl.textContent = 'No disponible';
    },
